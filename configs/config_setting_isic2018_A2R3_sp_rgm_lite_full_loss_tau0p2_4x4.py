from .config_setting_isic2018_A2R2_sp_rgm_lite_region_loss_tau0p2_4x4 import setting_config as base_setting_config


class setting_config(base_setting_config):
    """A2R3: A2R2 plus a lightweight compactness loss."""

    exp_name = 'A2R3_sp_rgm_lite_full_loss_tau0p2_4x4'
    output_dir = './outputs/isic2018/A2R3_sp_rgm_lite_full_loss_tau0p2_4x4'
    work_dir = output_dir + '/'
