...
class setting_config(base_setting_config):
    """G2: SuiT-style avg+max Superpixel Skip Refinement on stage1 skip."""

    exp_name = 'G2_ssr_stage1_skip_avgmax'
    output_dir = './outputs/isic2018/G2_ssr_stage1_skip_avgmax'
    work_dir = output_dir + '/'
