...
class setting_config(base_setting_config):
    """F1: one-path replacement SPScan on the final encoder stage2 VSSBlock."""

    exp_name = 'F1_vssblock_spscan_stage2_last_one_path'
    output_dir = './outputs/isic2018/F1_vssblock_spscan_stage2_last_one_path'
    work_dir = output_dir + '/'

    use_sp_rgm = False
    use_sp_scan = True
    sp_scan_stage = 'stage2'
    sp_scan_blocks = 'last'
