from .config_setting_isic2018_A1_sp_rgm_module_only_4x4 import setting_config as base_setting_config


class setting_config(base_setting_config):
    """A2: SP-RGM with auxiliary region reconstruction and compactness losses."""

    exp_name = 'A2_sp_rgm_full_loss_4x4'
    output_dir = './outputs/isic2018/A2_sp_rgm_full_loss_4x4'
    work_dir = output_dir + '/'
